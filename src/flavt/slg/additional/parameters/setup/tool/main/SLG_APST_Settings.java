...
public class SLG_APST_Settings {
    ...
    private boolean ReadSettings() {
        ...
        try {
            ...
            String strSettingsFilePathName = System.getenv( "SLG_ROOT") + "/etc/settings.additional.parameters.setup.tool.r.xml";
        ...
        if( bResOk == true) {
            try {
                ...
                String strSettingsFilePathName = System.getenv( "SLG_ROOT") + "/etc/settings.additional.parameters.setup.tool.rw.xml";
    ...
    public void SaveSettings() {
        try {
            ...
            //TODO
            String strSettingsXmlFile = System.getenv( "SLG_ROOT") + "/etc/settings.additional.parameters.setup.tool.rw.xml";
